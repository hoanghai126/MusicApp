...
public class PopularSongsFragment extends Fragment {
    private FragmentPopularSongsBinding fragmentPopularSongsBinding;
    private List<Song> mListSong;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        fragmentPopularSongsBinding = FragmentPopularSongsBinding.inflate(inflater, container, false);

        getListPopularSongs();
        initListener();

        return fragmentPopularSongsBinding.getRoot();
    }
    ...
    private void displayListPopularSongs() {
        ...
        fragmentPopularSongsBinding.rcvData.setLayoutManager(linearLayoutManager);

        SongAdapter songAdapter = new SongAdapter(mListSong, this::goToSongDetail);
        fragmentPopularSongsBinding.rcvData.setAdapter(songAdapter);
    }
